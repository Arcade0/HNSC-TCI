...
def em(sp_sga_l_v,
    ...
    A iteration which based on sklearn NB. This is used if DEG is discrete value.
...
def gmm(sp_sga_l_v,
    ...
    A iteration which based on sklearn BernoulliNB.This is used if DEG is continuous value.
